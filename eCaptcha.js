...
|___|_____|__,|  _|_| |___|_|_|__,|
              |_|first Unique Emoji Captcha Verification System.
              
©️Copyright 2021 - Healer And Thunder
...
var y2021 = "eCaptcha";
console.log("This Website is Using "+y2021);
...
//console.log(n[i]);
document.getElementById("ename").innerHTML = "Find ("+n[i]+") Out of These:";
...
const onClick = (event) => {
    if (event.target.nodeName === 'BUTTON') {
      if(event.target.id == j){
          ...
          //console.log("Error");
          document.getElementById("es").innerHTML = "Error";
          error.play();
          counter++;
      }
      if(counter > 1){
        document.getElementById("eCaptcha").style.display = "none";
        document.write("Sorry We Cannot Verify You At The Moment");
      }
    }
  }
...
/*------------ Copyright ------------------*/
document.getElementById("ecp").innerHTML = "©️Copyright eCaptcha 2021"